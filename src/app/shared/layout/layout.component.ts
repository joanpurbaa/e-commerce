...
export class LayoutComponent implements OnInit {
  ...
  private updateLayoutBasedOnUrl() {
    ...
    if (currentUrl === '/home') {
      ...
      this.showRightIcon = true;
      this.rightIconName = 'notifications-outline';
    } else if (currentUrl.startsWith('/details/')) {
      this.title = 'Details';
      this.showTopHeader = true;
      ...
      this.showRightIcon = true;
      this.rightIconName = 'notifications-outline';
    } else if (currentUrl === '/notifications-setting') {
      this.title = 'Notifications';
      this.showTopHeader = true;
      this.showBottomNav = true;
      this.showBackButton = true;
      ...
      this.showRightIcon = true;
      this.rightIconName = 'notifications-outline';
    } else if (currentUrl === '/help-center') {
      ...
      this.showRightIcon = true;
      this.rightIconName = 'notifications-outline';
    } else if (currentUrl === '/customer-service') {
      ...
      this.showRightIcon = true;
      this.rightIconName = 'notifications-outline';
    } else if (currentUrl === '/profil') {
      this.title = 'Your Profil';
      this.showTopHeader = true;
      this.showBottomNav = true;
      this.showBackButton = true;
      this.showRightIcon = true;
